...
__DEFINE__(1685102504033, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1685102504034,"./event-store":1685102504035}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1685102504034, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1685102504035, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1685102504034,"./utils":1685102504036}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1685102504036, function(require, module, exports) {
...
return __REQUIRE__(1685102504033);
})()
